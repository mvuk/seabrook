		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="service-group">
					...
					<a href="/workplace-law-services/investigations-training/" class="pill-button pink">Learn more</a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="service-group">
					<h2>Employees</h2>
					<p>Short summary about this service. Short summary about this service. Short summary about this service.</p>
					<a href="/workplace-law-services/employees" class="pill-button pink">Learn more</a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="service-group">
					<h2>Employers</h2>
					<p>Short summary about this service. Short summary about this service. Short summary about this service.</p>
					<a href="/workplace-law-services/employers" class="pill-button pink">Learn more</a>
				</div>
			</div>
